              ...
              {qrStatus === '2fa_required' ? (
                ...
                <div>
                  ...
                  <p style={{ fontSize: "11px", color: "#6b7280", margin: "0 0 8px 0" }}>
                    Scan with Telegram's built-in scanner:
                  </p>

                  {/* Open Telegram Devices Button */}
                  <button
                    onClick={() => {
                      window.location.href = 'tg://settings/devices';
                    }}
                    style={{
                      width: "100%",
                      padding: "10px",
                  ...
                  >
                    ...
                    Open Telegram Scanner
                  </button>
                  <p style={{ fontSize: "10px", color: "#9CA3AF", margin: "0 0 12px 0", textAlign: "center" }}>
                    Then tap "Link Desktop Device"
                  </p>
